                  ...
                  <div className="space-y-3">
                    <label className="flex items-center gap-3 cursor-pointer">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-400">Email me about new sign-ins</div>
                      </div>
                    </label>
                    ...
                    <label className="flex items-center gap-3 cursor-pointer">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-400">Send push notifications for new devices</div>
                      </div>
                    </label>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <label className="flex items-center gap-3 cursor-pointer">
                      <input
                        ...
                        onChange={(e) => handleChange('emailSecurity', e.target.checked)}
                        className="w-4 h-4 rounded bg-white/5 border-white/10"
                      />
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center gap-3 cursor-pointer">
                      <input
                        ...
                        onChange={(e) => handleChange('pushOrders', e.target.checked)}
                        className="w-4 h-4 rounded bg-white/5 border-white/10"
                      />
                    ...
                    <label className="flex items-center gap-3 cursor-pointer">
                      <input
                        ...
                        onChange={(e) => handleChange('pushMessages', e.target.checked)}
                        className="w-4 h-4 rounded bg-white/5 border-white/10"
                      />
                      <span>Messages</span>
                    </label>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    {['#3b82f6', '#8b5cf6', '#10b981', '#f59e0b', '#ef4444'].map((color) => (
                      <button
                        key={color}
                        onClick={() => showToast('info', 'Color Change', 'Implement color change functionality')}
            ...
            <div className="glass-card p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="pt-6 border-t border-white/10">
                  <button className="btn-primary w-full bg-gradient-to-r from-red-500 to-pink-500">
                    Clear All Data
                  </button>
